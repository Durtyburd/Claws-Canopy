...
public class OnlinePlayerController : NetworkBehaviour
{
    ...
    [Header("Crouch")] [Tooltip("Move speed while crouching in m/s")]
    ...
    [Header("Stamina")] [Tooltip("Maximum stamina")]
    ...
    public override void OnStartClient()
    {
        ...
        followCam.enabled = isLocalPlayer;
        ...
        {
            OnlineAudioManager.Instance.EndLobbySound();
